...
# Function to update display with button press
...
# Mapping buttons to their respective functions
...
Button(root, text="=", command=lambda: calculate()).grid(row=5, column=2, columnspan=2, sticky=N+S+E+W)
...
Button(root, text="pi", command=lambda: get_operation("*3.142")).grid(row=2, column=4, sticky=N+S+E+W)
