...
def addsongs():
    ...
    for s in temp_song:
        s=s.replace("C:/Users/Desktop/Music/","") #path to music folder
...
def Play():
    ...
    song=f'C:/Users/Desktop/Music/{song}' #path to music folder
...
def Previous():
    ...
    temp2=f'C:/Users/Desktop/Music/{temp2}' #path to music folder
...
def Next():
    ...
    temp=f'C:/Users/Desktop/Music/{temp}' #path to music folder
